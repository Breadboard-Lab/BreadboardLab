...
function requireDomNodePromise(el) {
...
function getDimensions(el, clone, width, height) {
...
function detectCssFont(rule, href) {
...
function prepareSvg(el, options, done) {
  requireDomNode(el);
...
function svgAsDataUri(el, options, done) {
  requireDomNode(el);
...
function svgAsPngUri(el, options, done) {
  requireDomNode(el);
...
function download(name, uri, options) {
...
function saveSvg(el, name, options) {
