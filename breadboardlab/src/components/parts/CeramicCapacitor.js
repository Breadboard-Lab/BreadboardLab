    ...
    render() {
        ...
        return (
			...
			l-4.338-12.817c0-0.502,5.143-0.908,6.125-0.908l0,0c0.982,0,6.125,0.406,6.125,0.908L46.799,62.589z"/>
                    <path id="leftpin" fill="#cb6c34" d="M20.775,62.589c0,0.498-0.8,0.911-1.783,0.911l0,0c-0.986,0-1.787-0.411-1.787-0.911
                l-4.337-12.817c0-0.502,5.138-0.908,6.125-0.908l0,0c0.983,0,6.12,0.406,6.12,0.908L20.775,62.589z"/>
                    <circle id="body" fill="#cb6c34" cx="32" cy="29.063" r="28.563"/>
                    <path id="shadows" fill="#b7602f" d="M43.68,55.128c0.147-0.438,0.337-0.865,0.6-1.271c0.004-0.006,0.007-0.013,0.011-0.02
                ...
                c3.163,0,6.203-0.521,9.047-1.472l2.178,6.435c0,0.5,0.805,0.911,1.787,0.911C45.012,63.5,42.407,58.891,43.68,55.128z"/>
                    <path id="lights" fill="#d5895d" d="M13.52,12.909c-0.128,0-0.259-0.025-0.385-0.078c-0.508-0.213-0.749-0.795-0.538-1.304
                ...
                c-4.021,0.414-5.617,4.08-5.683,4.236C14.281,12.678,13.91,12.909,13.52,12.909z"/>
                    <path id="select" fill="none" stroke={this.state.isSelected ? "#2453ff" : "none"}
                          strokeMiterlimit="10" strokeWidth="4.5" d="M60.563,29.063
