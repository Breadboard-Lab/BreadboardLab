    ...
    render() {
        return (
            <g ref={this.node} onDoubleClick={this.onDoubleClick}>
                <path id="rightpin" fill="#019ABF" d="M46.799,62.589c0,0.498-0.805,0.911-1.787,0.911l0,0c-0.982,0-1.787-0.411-1.787-0.911
			...
			l-4.337-12.817c0-0.502,5.138-0.908,6.125-0.908l0,0c0.983,0,6.12,0.406,6.12,0.908L20.775,62.589z"/>
                <circle id="body_3_" fill="#019ABF" cx="32" cy="29.063" r="28.563"/>
