    ...
    render() {
        ...
        return (
            ...
            c0-3.399,2.25-6.181,5-6.181h52.999c2.75,0,5.001,2.781,5.001,6.181V35.631z"/>
                    ...
                    <rect id="togglebevelbody" x={this.state.isToggled ? "32" : "11.49"} y="21.666" fill="#606161"
                          width="20.376" height="13.919"/>
                    <rect id="togglebevel1" x={this.state.isToggled ? "32" : "11.49"} y="21.666" fill="#707071"
                          width="2.93" height="13.922"/>
                    <rect id="togglebevel2" x={this.state.isToggled ? "37.859" : "17.349"} y="21.665" fill="#707071"
                          width="2.931" height="13.92"/>
                    <rect id="togglebevel3" x={this.state.isToggled ? "43.72" : "23.209"} y="21.666" fill="#707071"
                          width="2.93" height="13.922"/>
                    <rect id="togglebevel4" x={this.state.isToggled ? "49.58" : "29.07"} y="21.665" fill="#707071"
                          width="2.93" height="13.92"/>
                    <path id="select" fill="none" stroke={this.state.isSelected ? "#2453ff" : "none"}
                          strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" d="
